...
<div class="mb-6 flex items-center justify-between">
    <div>
        ...
        <h1 class="text-3xl font-extrabold text-gray-900 dark:text-white">Book Appointment</h1>
    </div>
</div>
...
<div class="glass rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-8 max-w-2xl">
    <form action="{{ route('appointments.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <textarea name="chief_complaint" rows="4" placeholder="e.g., Pain in upper right molar, Routine checkup..."
        ...
        <div class="flex gap-3 pt-4">
            <button type="submit" class="px-8 py-3 bg-primary text-white font-bold rounded-xl hover:bg-primary/90 transition flex items-center gap-2">
                <i data-lucide="check-circle" class="w-4 h-4"></i> Book Appointment
            </button>
