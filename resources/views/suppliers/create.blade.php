...
<div class="mb-6 flex items-center justify-between">
    <div>
        ...
        <h1 class="text-3xl font-extrabold text-gray-900 dark:text-white">Add Supplier</h1>
        <p class="text-gray-500 dark:text-gray-400 mt-1">Register a new vendor</p>
    </div>
</div>
    ...
    <form action="{{ route('suppliers.store') }}" method="POST" class="space-y-6">
        ...
        <div class="flex gap-3 pt-4">
            <button type="submit" class="px-8 py-3 bg-primary text-white font-bold rounded-xl hover:bg-primary/90 transition flex items-center gap-2">
                <i data-lucide="check" class="w-4 h-4"></i> Create Supplier
            </button>
